...
export const featuredData: FeaturedItem[] = [
  {
    ...
    imgUrl: "/images/kuchistore-v2.png",
    icon: (
      <Button className="size-8 rounded-full relative bg-white hover:bg-neutral-100 hover:ring hover:ring-blue-400">
        <Image
          sizes="100%"
  ...
  },
  {
    ...
    icon: (
      <Button className="size-8 rounded-full relative bg-white hover:bg-neutral-100 hover:ring hover:ring-red-500">
        <Image
          sizes="100%"
  ...
  },
  {
    ...
    icon: (
      <Button className="size-8 rounded-full relative bg-white hover:bg-neutral-100 hover:ring hover:ring-neutral-900">
        <Image
          sizes="100%"
          src={"/images/tools/next-js.png"}
          fill
          className="p-1"
          alt=""
        />
