...
export default function ProfileCard(){
    return(
        <div className="grid relative bg-white drop-shadow-sm rounded-md">
                ...
                <div className="lower md:px-10 rounded-b-sm">
                    <div className="flex max-sm:flex-col items-center gap-4 h-full">
                        <Image src="/images/takina3.jpg" width={200} height={200} className="object-cover relative max-sm:absolute sm:left-6 bottom-30 max-sm:bottom-45 p-3 bg-white rounded-full" alt=""/>
                        <div className="flex flex-col h-full justify-evenly max-sm:pt-20 p-6 gap-4">
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex max-md:grid grid-cols-2 place-items-center sm:items-center gap-1">
                                    ...
                                    <Badge className="bg-blue-500 text-white"><Laptop/>Frontend Developer</Badge>
                                    <Badge className="bg-yellow-500 text-white"><Settings/>Backend Developer</Badge>
                                </div>
                            </div> 
