...
export default function Herosection(){
    ...
    return(
            <section className="grid lg:grid-cols-[0.8fr_0.2fr] max-lg:grid-rows-[1fr_0.4fr] gap-3">
                <div className="image1 flex relative h-[40vh] p-3 drop-shadow-sm">
                    <Image sizes="100%" src="/images/takina-inoue.jpg" loading="eager" fill className="object-cover rounded-sm" alt="waifu-pic"/>
                ...
                <div className="image2 grid lg:grid-rows-2 max-lg:grid-cols-2 max-lg:h-[16vh] gap-2">
                    <div onClick={()=>toast.info("Halaman Belum Tersedia")} className="relative drop-shadow-sm flex w-full items-center justify-center" onMouseEnter={()=>setToggleMusic(true)} onMouseLeave={()=>setToggleMusic(false)}>
                        <Image sizes="100%" src="/images/Musics.jpg" loading="eager" className="rounded-sm opacity-70" fill alt="Music-Playlist"/>
                    ...
                    <div onClick={()=>toast.info("Halaman Belum Tersedia")} className="relative drop-shadow-sm flex w-full items-center justify-center" onMouseEnter={()=>setToggleList(true)} onMouseLeave={()=>setToggleList(false)}>
                        <Image sizes="100%" src="/images/listnimek.jpg" loading="eager" className="rounded-sm" fill alt="Anime-Playlist"/>
